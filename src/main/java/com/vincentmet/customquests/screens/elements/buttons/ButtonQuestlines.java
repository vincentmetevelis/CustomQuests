...
@OnlyIn(Dist.CLIENT)
public class ButtonQuestlines implements IQuestingGuiElement {
    private Screen root;
    ...
    public ButtonQuestlines(Screen root){
        this.root = root;
        this.label = new Label(root, "Q", x + (WIDTH>>1), y + (HEIGHT>>1), 0xFFFFFF, true, true);
    }

...
public class ButtonParties implements IQuestingGuiElement {
    ...
    public ButtonParties(Screen root, int posX, int posY){
        this.root = root;
        this.x = posX;
        this.y = posY;
    }
    ...
    public void render(IQuestingGuiElement gui, PlayerEntity player, double mouseX, double mouseY) {
        String text = ScreenQuestingDevice.isPartyScreenOpen ? "Close" : "Parties";
    ...
    public void onClick(IQuestingGuiElement gui, PlayerEntity player, double mouseX, double mouseY) {
        if(Utils.isMouseInBounds(mouseX, mouseY, x, y, x+WIDTH, y+HEIGHT)){
            ScreenQuestingDevice.isPartyScreenOpen = !ScreenQuestingDevice.isPartyScreenOpen;
        }
    }

    ...
    public static class SpawnEntity implements IQuestReward{
        ...
        public void executeReward(PlayerEntity player) {
            if(player.world instanceof ServerWorld){
                for(int i=0; i<amount;i++)player.getEntityWorld().getServer().getWorld(World.OVERWORLD).summonEntity(entity.create((ServerWorld)player.world, new CompoundNBT(), new TranslationTextComponent("Your Reward <3"), player, player.getPosition(), SpawnReason.COMMAND, true, false));
            }
        }
